...
var BlackjackJS = (function() {
	...
	const urlGameState = "http://localhost:5000/testGameState";
	...
	var Game = new function(){
		...
		*/
		...
		this.renderTable = function(){
			...
			var dealerScore = playerJSON.playerDoc.currentHand[0].dealerScore;
			var playerScore = playerJSON.playerDoc.currentHand[0].score;
			var dealerHand = playerJSON.playerDoc.currentHand[0].dealerHand;
			var playerHand = playerJSON.playerDoc.currentHand[0].hand;
				//TODO needs to be expanded..
			...
			if  (gameStateJSON.gameInfo.state == "gameOver"){
			dealerHand.forEach(
		...
		*/
		this.init = function(){
			...
			var score = playerJSON.playerDoc.hands[0].score
